...
public class ConfigurationBean {
     ...
     * property created via Model RelationshipService, which is available for injection.
     * 
     * According to the requirement of Model RelationshipService, there must be clear separation between service code and models
     * code. A model (cache, configuration property, channel or event) should be defined and created in it own project.
     * See Model RelationshipService SDK for more details. Here we created several modeled configuration properties in jee testsuite
